...
const Food = ({ filters }) => {
  ...
  const fetchURL =
    "https://raw.githubusercontent.com/kkb-mmmut/zomato_clone/main/data.json";
  ...
  return (
    <>
      <div className="text-gray-400  body-font">
        <div className="container food-body p3x-1 py-1 md:mx-auto">
          <div className="flex flex-wrap md:-m-2 md:pl-6 foods-container">
            {filteredRes.map((food, index) => (
              <div
                key={index}
                className="p-4 mb-4 transform transition duration-200 rounded-lg hover:scale-105 hover:shadow-lg food-container"
              >
